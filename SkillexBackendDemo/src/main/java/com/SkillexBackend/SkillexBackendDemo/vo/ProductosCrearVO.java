...
public class ProductosCrearVO implements Serializable {
	...
	public ProductosCrearVO(Integer idProductos, String nombreProducto, String nombreProductoIn, String codigoProducto,
			String estadoProducto, Integer cantidadProducto, Date fechaIngreso, Integer inventario_id_inventario,
			Integer categoria_producto_id_categoria_producto, Integer id_detalle_productos, Integer valor_inicial,
			Integer valor_mas_iva, String descripcion_producto, String descripcion_producto_in, String nombre_imagen, String url_imagen) {
